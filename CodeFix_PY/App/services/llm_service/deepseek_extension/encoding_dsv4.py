...
You have access to a set of agent_boost to help answer the user's question. You can invoke agent_boost by writing a "<{dsml_token}tool_calls>" block like the following:
...
def render_tools(tools: List[Dict[str, Union[str, Dict[str, Any]]]]) -> str:
    ...
    Returns:
        Formatted agent_boost section string.
    """
...
def encode_messages(
    ...
    # Resolve drop_thinking: if any message has agent_boost defined, don't drop thinking
    effective_drop_thinking = drop_thinking
    if any(m.get("agent_boost") for m in full_messages):
