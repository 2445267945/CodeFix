...
from ...models.enum.agent_command import AgentCommand
...
class AgentMsgService(BaseMsgHandler):
    ...
    def __init__(self):
        self.command_handlers = {
            ...
            AgentCommand.RESUME: self.handle_resume,
            AgentCommand.RETRY: self.handle_retry,
    ...
    def agent_report(self, agent: BaseAgent, event: AgentEvent, output: dict):
    ...
    def assemble(self, event: AgentEvent, agent: BaseAgent, output) -> AgentMessage:
